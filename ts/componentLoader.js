...
import { goBackwardWeek, goForwardWeek, init_ui } from './ui';
window.onload = function () {
    document.getElementById("logon_btn").addEventListener("click", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sid = yield obtainSessionID("05719033", "210501ko!!");
    ...
    const ptr = PullToRefresh.init({
        ...
        onRefresh() {
            return __awaiter(this, void 0, void 0, function* () {
                let res = yield fetch("schedule.html");
                let a = yield res.text();
